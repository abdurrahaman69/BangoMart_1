...
<div class=" flex-row-reverse right ">
    ...
    <form action="checkout.php" method="post">
        ...
        <div class="container mt-2">
            ...
            <form>
                <div class=" float-none float-sm-none float-md-none float-lg-right float-xl-rightcheckout mr-0 p-2 mb-5   " style="border-radius:5%;">
                    <h4 style="font-family: sans-serif"><b>Grand total = Tk. <?php echo $_SESSION['grandtotal']; ?> </b></h4>
                </div>
                            ...
                            while ($phones = mysqli_fetch_array($run_get_phone)) {
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td data-label="Total (in Tk)"><?php echo $subtotal; ?></td>
                                        <?php
        ...
        <div class="container mt-5">
            ...
            <div class="payment">
                <h4>Payment Options :-
                    <input type="radio" aria-label="Radio button for following text input" name="payment" value="bkash" required>
                    <img src="../Images/Website/bkash.png" alt="bkash" style="height:37px !important;background-color: white;" class="paytm">
                    <input type="radio" aria-label="Radio button for following text input" name="payment" value="nogod" required>
                    <img src="../Images/Website/nogod.png" alt="nogod" style="height:37px !important" class="cod">
                </h4>
            </div>
        ...
        <div class="container">
            <div class="row text-center text-xs-center text-sm-left text-md-left">
                <div class="col aligncenter">
                    ...
                    <img src="../Images/Website/bkash.png" alt="bkash" style="height:37px !important;background-color: white;">
                    <img src="../Images/Website/nogod.png" alt="nogod" style="height:37px !important">
                </div>
            </div>
            <div class="row">
