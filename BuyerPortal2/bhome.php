...
<body>
    ...
    <div class="container"> <img src="banner.jpg" class="img-fluid firstimage d-block mx-auto" alt="Responsive image">
    </div>
    <br>
    <br>
    ...
    <div class="container">
        ...
        <div class="text-center">
            <h1 id="headings" class="longguard"><span><b>Best Selling Products All Over Bangladesh </b></span>
            </h1>
        </div>
        <br>
        <div class="row">
